...
git mv _старое имя_ _новое имя_ - переименование папки или файла. используется также для перемещения файлов и папок со следеющим синтаксисом git mv _old/file.txt_ _new/file.txt_  
  
git rm _имя файла_ - удалить файл из рабочего каталога и из индекса Git  
  
git rm --cached _имя файла_ - удалить из индекса Git, но не удалять сам файл в рабочем каталоге  
